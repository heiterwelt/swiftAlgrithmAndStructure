...
public class SwiftGraph {
    ...
    func addEdge(source source: Vertex, neighbor: Vertex, weight: Int) {
        ...
        print("The neighbor of vertex: \(source.key as String!) 's neighbor \(neighbor.key as String!)..")
        ...
        if (isDirected == false) {
            ...
            print("The neighbor of vertex: \(neighbor.key as String!) 2's neighbor \(source.key as String!)..")
